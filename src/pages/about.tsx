        ...
        <article className="mx-5 flex flex-col items-center justify-center pt-5 text-[#FFFFFB] md:h-screen">
          <div className="sm:max-w-2xl">
            ...
            <p className="my-5">
              ...
              2013 & 2014 Calibre Design Competition Nominee<span>&#41;</span>.
              in addition. ArcelDesign, Inc., brings talent and imagination to
            ...
            <p className="my-5">
              ...
              client's business, but of our own creativity and who we are. This
              is why we are proud of our work.
            </p>
